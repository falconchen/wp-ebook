...
function newsanchor_scripts() {
	...
	if ( get_theme_mod('body_font_name') !='' ) {
	    wp_enqueue_style( 'newsanchor-body-fonts', '//fonts.cat.net/css?family=' . esc_attr(get_theme_mod('body_font_name')) ); 
	} else {
	    wp_enqueue_style( 'newsanchor-body-fonts', '//fonts.cat.net/css?family=PT+Sans:400,700');
	}

	if ( get_theme_mod('headings_font_name') !='' ) {
	    wp_enqueue_style( 'newsanchor-headings-fonts', '//fonts.cat.net/css?family=' . esc_attr(get_theme_mod('headings_font_name')) ); 
	} else {
	    wp_enqueue_style( 'newsanchor-headings-fonts', '//fonts.cat.net/css?family=Droid+Serif:400,700'); 
	}
